...
public class filesMain {
    public static void main(String[] args) {
        final String WRITE_SLOTS_PATH = "E:\\Coworks with GUI\\coworking-space-system\\src\\main\\resources\\slots.json";
        final String READ_SLOTS_PATH = "E:\\Coworks with GUI\\coworking-space-system\\src\\main\\resources\\slots.json";
...
//        GeneralVisitor gen = new GeneralVisitor("rahma",1);
//        GeneralVisitor gen2 = new GeneralVisitor("hob hob",2);
